package com.my.authserver.common.web.converter.enumconverter;

import com.my.authserver.member.enums.Sex;

import static com.my.authserver.member.enums.Sex.FEMALE;
import static com.my.authserver.member.enums.Sex.MALE;
